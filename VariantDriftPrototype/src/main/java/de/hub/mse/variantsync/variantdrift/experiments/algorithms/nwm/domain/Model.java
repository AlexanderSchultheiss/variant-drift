...
public class Model {
    ...
    private String id;
    private String refactoringInfo;
...
//	}
    ...
    public void setRefactoringInfo(String info) {
    ...
    public static ArrayList<Model> readModelsFile(String filePath, String seperator) {
        ...
        ArrayList<Model> models = new ArrayList<Model>();
        String currModelId = "-1";
        String refactoringMetaData = null;
        try {
            ...
            while (true) {
                ...
                if (modelLine.startsWith("RefactoringMeta")) {
                    refactoringMetaData = modelLine;
                    continue;
                }
                ...
                e.setAsRaw();
                mdl.addElement(e);
                mdl.setRefactoringInfo(refactoringMetaData);
            }
            reader.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        if (sortedElems == null) {
            ...
            Collections.sort(sortedElems, new Comparator<Element>() {
                ...
                public int compare(Element e1, Element e2) {
                    return e1.getProperties().toString().compareTo(e2.getProperties().toString());
                }
            });
        }
        return sortedElems;
