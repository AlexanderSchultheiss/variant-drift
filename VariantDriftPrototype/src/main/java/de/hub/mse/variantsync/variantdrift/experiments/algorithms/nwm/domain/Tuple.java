package de.hub.mse.variantsync.variantdrift.experiments.algorithms.nwm.domain;
...
//			//	sumOfElementSizes / (propertiesUnionSize*numOfModels); //sumOfElementSizes*elemsCnt / (propertiesUnionSize*sqModelSize);
	...
	public boolean equals(Object o) {
		if (o instanceof Tuple){
			Set<Element> elementsOfThis = new HashSet<>(this.getRealElements());
			Set<Element> elementsOfThat = new HashSet<>(((Tuple) o).getRealElements());
			return elementsOfThis.equals(elementsOfThat);
		}
		return false;
	}
	...
	// HAD TO CHANGE THIS BECAUSE IT IS NOT IMPLEMENTED WELL
	...
	public BigDecimal calcWeight(ArrayList<Model> mdls) {
		...
		numberOfModels = mdCount;
		double weight = NwmWeight.weightForElements(this.getRealElements(),
