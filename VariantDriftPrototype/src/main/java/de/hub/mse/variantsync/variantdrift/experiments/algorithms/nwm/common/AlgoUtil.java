package de.hub.mse.variantsync.variantdrift.experiments.algorithms.nwm.common;
...
import de.hub.mse.variantsync.variantdrift.experiments.algorithms.nwm.alg.TupleExaminer;
import de.hub.mse.variantsync.variantdrift.experiments.algorithms.nwm.alg.merge.HungarianMerger;
import de.hub.mse.variantsync.variantdrift.experiments.algorithms.nwm.alg.merge.MergeDescriptor;
...
//		}
	...
	private static boolean haveCommonProperty(Element e1, Element e2) {
		List<String> e1Props = e1.getProperties();
