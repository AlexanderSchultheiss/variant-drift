...
public class EScanDetectionOriginal extends EScanDetection {
     ...
     *
     * @param f            the first parameter from the article
     * @param fClones      the second parameter from the article, fClones contains f and
     *                     all of f clones
     * @param lattice      the data structure eScan works with, the first layer must
     ...
     * @param edgesLayer1  the edges a fragment maybe be extended with, q.v.
     *                     Fragment.extensOp
     * @param kFromArticle the k-th layer of lattice, in the article lattice starts with
