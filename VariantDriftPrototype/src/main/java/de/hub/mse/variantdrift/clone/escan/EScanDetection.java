...
public abstract class EScanDetection extends CloneDetection {
    ...
    /**
     * @param fragment - the cloneCandidates-Set are searched for clones of this
     *                 Fragment
     ...
     * removed
     *
     * @param groupedLayerLattice lattice already grouped accordingly to eScan pseudocode line 4
     */
