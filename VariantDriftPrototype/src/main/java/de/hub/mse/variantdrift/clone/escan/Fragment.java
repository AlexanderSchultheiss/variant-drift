...
public class Fragment {
     ...
     *
     * @param f the Fragment this Fragment should be compared to
    ...
    /**
     * @param biggerFragment the Fragment that maybe contains this Fragment.
    ...
    /**
     * @param onlyThisCapsuleEdges the CapsuelEdges this fragment should be extended with (a
